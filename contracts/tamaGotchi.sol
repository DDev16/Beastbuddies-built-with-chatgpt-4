    ...
    ERC721Burnable
{
    ...
    event NewBattle(uint256 indexed battleId, uint256 attackerTokenId, uint256 defenderTokenId);
    event BattleUpdate(uint256 indexed battleId, uint256 attackerHp, uint256 defenderHp);
    ...
    uint256 private BATTLE_COOLDOWN = 0 hours;
